...
const reformatAnimals = farmAnimals.split(' ');
const [moo, neigh, baa, oink, cluck] = reformatAnimals;
//reformatAnimals.splice(1, 1);

// 2. Bolt the horse wandered off, so just give us four animals, and let's name them Bessie, Dolly, Babe, and Little.
const [Bessie, , Dolly, Babe, Little] = reformatAnimals;
//reformatAnimals.pop();
...
const [black_and_white, , black, pink, ] = reformatAnimals;
...
// This is unbelievably dirty. I do not like this syntax very much.
const { k_name , k_color , k_album: { the_muppet_movie: { song_1, song_2, song_3, song_4} }, k_job, k_partner} = k_muppet;